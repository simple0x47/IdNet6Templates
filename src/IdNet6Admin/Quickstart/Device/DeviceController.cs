...
namespace IdNet6.Quickstart.UI.Device
{
    [Authorize]
    [SecurityHeaders]
    public class DeviceController : Controller
    {
        ...
        private DeviceAuthorizationViewModel CreateConsentViewModel(string userCode, DeviceAuthorizationInputModel model, Client client, Resources resources)
        {
            ...
            if (ConsentOptions.EnableOfflineAccess && resources.OfflineAccess)
            {
                ...
                {
                    GetOfflineAccessScope(vm.ScopesConsented.Contains(IdNet6.IdentityServerConstants.StandardScopes.OfflineAccess) || model == null)
                });
            }
        ...
        private ScopeViewModel GetOfflineAccessScope(bool check)
        {
            return new ScopeViewModel
            {
                Name = IdNet6.IdentityServerConstants.StandardScopes.OfflineAccess,
